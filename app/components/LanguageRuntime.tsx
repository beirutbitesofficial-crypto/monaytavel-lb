...
const fr:Record<string,string>={
  ...
  'Travel, Events & MICE Services':'Voyages, événements & services MICE','MICE in Lebanon':'MICE au Liban','Meetings, Conferences & Events':'Réunions, conférences & événements','Meetings':'Réunions','Conferences & Congresses':'Conférences & congrès','Corporate Events':'Événements corporate','Incentives & Team Building':'Incentives & team building','Meetings & Corporate Events':'Réunions & événements corporate','Incentive Travel & Team Building':'Voyages incentive & team building','Event & Exhibition Logistics':'Logistique événements & expositions','Explore Mona Travel MICE →':'Découvrir Mona Travel MICE →'
};
...
const ar:Record<string,string>={
  ...
  'Travel, Events & MICE Services':'خدمات السفر والفعاليات وMICE','MICE in Lebanon':'خدمات MICE في لبنان','Meetings, Conferences & Events':'الاجتماعات والمؤتمرات والفعاليات','Meetings':'الاجتماعات','Conferences & Congresses':'المؤتمرات والكونغرسات','Corporate Events':'فعاليات الشركات','Incentives & Team Building':'الحوافز وبناء الفرق','Meetings & Corporate Events':'الاجتماعات وفعاليات الشركات','Incentive Travel & Team Building':'رحلات الحوافز وبناء الفرق','Event & Exhibition Logistics':'لوجستيات الفعاليات والمعارض','Explore Mona Travel MICE →':'استكشف خدمات MICE من Mona Travel ←'
};
